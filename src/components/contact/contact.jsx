    ...
    <section id='contact'>c
      ...
      <div className="container contact__container">
        ...
        <article className="contact__option">
          ...
          <a href="mailto:demmyegator@gmail.com" target="_blank" rel="noreferrer">Send a message</a>
        </article>
        <article className="contact__option">
          <RiMessengerLine className='contact__option-icon'/>
          <h4>Messenger</h4>
          <h5>rolandototo</h5>
          <a href="https://m.me.rolandototo.archiver" target="_blank" rel="noreferrer">Send a message</a>
        </article>
        <article className="contact__option">
